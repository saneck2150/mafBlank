// main.dart – две «перелистывающиеся» страницы: речь + голосование
// ---------------------------------------------------------------------
// Структура:
//   MyApp                       – корневой MaterialApp
//   GamePage (StatefulWidget)   – держит общее состояние игры
//      • экран 0 – MainScreen   – таймер + фолы/выставления (то, что уже было)
//      • экран 1 – VotingScreen – таблица «Порядок выставления / Раунды голосования»
// Переключение страниц жестом свайпа (PageView). Состояние общее.
// ---------------------------------------------------------------------
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/game': (_) => const GamePage(), // ваш существующий экран
      },
      initialRoute: '/',
    );
  }
    ...
    return Scaffold(
      ...
      body: Center(
        child: ElevatedButton.icon(
          ...
          onPressed: () {
            // pushReplacement, если вы не хотите «Назад» к меню:
